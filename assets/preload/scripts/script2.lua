...
function onGameOver()
    if not GameOverActive and not enableEnd and IndieCrossGameOverStyle == 'Cuphead' then
...
function onEndSong()
    if GameOverActive and not enableSong and IndieCrossGameOverStyle == 'Cuphead' then
        return Function_Stop;
    end
    return Function_Continue;
end
    ...
    if IndieCrossGameOverStyle == 'Cuphead' then
        ...
        if GameOverState == 2 then
            ...
            if CupSelection == 0 then
                ...
                if keyJustPressed('accept') or keyJustPressed('esc') then
                    enableEnd = true
