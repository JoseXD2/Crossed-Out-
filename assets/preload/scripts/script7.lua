...
function onCreatePost()
    if difficulty ~= 0 then
        ...
        if songName == 'Despair' then
            makeAnimatedLuaSprite('Piper','bendy/images/third/PiperDespair',2500,getProperty('boyfriend.y') - 200)
            addAnimationByPrefix('Piper','Walking','pip walk instance 1',24,true)
            addAnimationByPrefix('Piper','Idle','Piperr instance 1',24,false)
            addAnimationByPrefix('Piper','Hurt','Piper gets Hit instance 1',24,false)
            addAnimationByPrefix('Piper','Dead','Piper ded instance 1',24,false)
            ...
            makeAnimatedLuaSprite('Striker','bendy/images/third/StrikerDespair',-200,getProperty('boyfriend.y') - 160)
            addAnimationByPrefix('Striker','Walking','Str walk instance 1',24,true)
            addAnimationByPrefix('Striker','Hurt','Sticker  instance 1',24,false)
            addAnimationByPrefix('Striker','Dead','I ded instance 1',24,false)
            addAnimationByPrefix('Striker','Pre-Attack','PunchAttack_container instance 1',24,false)
            ...
            AttackEnable = false
            addLuaScript('custom_notetypes/BendySplashNote')
        end
    end
...
function onUpdate(elapsed)
    ...
    if (AttackEnable) then
        ...
        if (PiperSpawn == 0) then
            ...
            setProperty('Piper.y', getProperty('boyfriend.y') + 40)
            PiperHP = 3
        ...
        if (StrikerSpawn == 0) then
            ...
            setProperty('Striker.y', getProperty('boyfriend.y') + 50)
        ...
        if (StrikerHP > 0 and StrikerX == true) then
            ...
            if (StrikerAttack == StrikerAttackTimeMax and StrikerAttacking == false) then
                ...
                triggerEvent('Camera Follow Pos', getProperty('boyfriend.x') - 150, getProperty('boyfriend.y') - 75)
        ...
        if PiperHP > 1 then
            if getProperty('Piper.x') > getProperty('boyfriend.x') + 400 and PiperX == false then
        ...
        if StrikerHP > 1 then
            if getProperty('Striker.x') < getProperty('boyfriend.x') - 300 and StrikerX == false  then
        ...
        if (getProperty('Piper.animation.curAnim.name') == 'Pre-Attack' or getProperty('Striker.animation.curAnim.name') == 'Pre-Attack' and BFBendy_Attacking == false) then
...
function onStepHit()
    ...
    if difficulty ~= 0 then
        ...
        if songName == 'Despair' then
            ...
            if curStep == 1680 or curStep == 3023 or curStep == 3912 and difficulty ~= 0 then
                PiperHP = 0
                StrikerHP = 0
                objectPlayAnimation('Striker','Dead',false)
                objectPlayAnimation('Piper','Dead',false)
